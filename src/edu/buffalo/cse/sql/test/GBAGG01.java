...
public class GBAGG01 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new GBAGG01());
  }
  public void testRA() {
    ...
    query_0.addAggregate(new AggregateNode.AggColumn("Sum", new ExprTree.VarLeaf(null, "B"),AggregateNode.AType.SUM));
    query_0.setChild(child_1);
    TestHarness.testQuery(tables, getResults0(), query_0);
    System.out.println("Passed RA Test GBAGG01");
  }
  public void testSQL() {
    List<List<List<Datum[]>>> expected = new ArrayList<List<List<Datum[]>>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/GBAGG01.SQL"),
                            expected);
    System.out.println("Passed SQL Test GBAGG01");
  }
  ...
  ArrayList<Datum[]> getResultsUD0() {
    ...
    ret.add(new Datum[] {new Datum.Int(2), new Datum.Int(7)}); 
    ret.add(new Datum[] {new Datum.Int(3), new Datum.Int(4)}); 
    ret.add(new Datum[] {new Datum.Int(4), new Datum.Int(9)}); 
    ret.add(new Datum[] {new Datum.Int(5), new Datum.Int(8)}); 
    return ret;
  }
  ArrayList<Datum[]> getResultsFlipGB0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(3), new Datum.Int(1)}); 
    ret.add(new Datum[] {new Datum.Int(7), new Datum.Int(2)}); 
    ret.add(new Datum[] {new Datum.Int(4), new Datum.Int(3)}); 
    ret.add(new Datum[] {new Datum.Int(9), new Datum.Int(4)}); 
    ret.add(new Datum[] {new Datum.Int(8), new Datum.Int(5)}); 
    return ret;
  }
}
